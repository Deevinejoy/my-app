...
export default function BlogPost() {
    ...
    if (loading) return <div className="h-[80vh] flex items-center justify-center text-xl">Loading post...</div>;
    if (!post) return <div className="text-center text-xl">No post found.</div>;
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="bg-white mb-6 p-6 rounded-lg shadow-lg">
                <h2 className="text-3xl font-bold text-center text-gray-900 mb-4" dangerouslySetInnerHTML={{ __html: post.title }} />
                <div className="mt-4 text-lg text-gray-700" dangerouslySetInnerHTML={{ __html: post.content }} />
